...
const FetchAPI = () => {
    ...
    return (
        <div>
            ...
            <input className="todo-input" style={{margin: "10px"}} type="text" placeholder="Enter a number..." onChange={(e) => {setLimit(e.target.value)}} />
            <hr/>
                                    ...
                                    <>
                                        ...
                                        <ul className="users-container">
                                            {photos.map((eachPhoto) => {
                                                ...
                                                return (
                                                    <li className="user-container" key={id}>
                                                        <div><img style={{width: "100px"}} src={url} alt={title}></img></div>
